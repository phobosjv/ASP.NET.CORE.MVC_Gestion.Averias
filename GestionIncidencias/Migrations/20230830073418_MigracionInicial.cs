        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CorreoPara = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CorreoCopia = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModelosDispositivos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModelosDispositivos_Tecnicos_TecnicoId",
                        column: x => x.TecnicoId,
                        principalTable: "Tecnicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModelosDispositivos_TiposDispositivos_TipoDispositivoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeloDispositivoId = table.Column<int>(type: "INTEGER", nullable: false),
                    OficinaId = table.Column<int>(type: "INTEGER", nullable: false),
                    Activo = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispositivos_ModelosDispositivos_ModeloDispositivoId",
                        column: x => x.ModeloDispositivoId,
                        principalTable: "ModelosDispositivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dispositivos_Oficinas_OficinaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Incidencias_Dispositivos_DispositivoId",
                        column: x => x.DispositivoId,
                        principalTable: "Dispositivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incidencias_Oficinas_OficinaId",
                        column: x => x.OficinaId,
                        principalTable: "Oficinas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_ModeloDispositivoId",
                table: "Dispositivos",
                column: "ModeloDispositivoId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_OficinaId",
                table: "Dispositivos",
                column: "OficinaId");

            migrationBuilder.CreateIndex(
                name: "IX_Incidencias_DispositivoId",
                table: "Incidencias",
                column: "DispositivoId");

            migrationBuilder.CreateIndex(
                name: "IX_Incidencias_OficinaId",
                table: "Incidencias",
                column: "OficinaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModelosDispositivos_TecnicoId",
                table: "ModelosDispositivos",
                column: "TecnicoId");

            migrationBuilder.CreateIndex(
                name: "IX_ModelosDispositivos_TipoDispositivoId",
                table: "ModelosDispositivos",
